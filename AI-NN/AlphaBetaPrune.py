# Write a program to implement Alpha Beta pruning in Python. The algorithm can be applied to any depth of
# tree by not only pruning the tree leaves but also the entire subtree. Order the nodes in the tree such that
# the best nodes are checked first from the shallowest node. Use domain knowledge while finding the best move.
