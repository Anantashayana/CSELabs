# Problem Statement for uniform cost search : We have the Map of Romania. In this map, the distance between 
# various places in Romania is given. If we have to reach from one place to another place there exist several 
# paths. Write a Python Program to find the shortest distance between any two places using a uniform cost search.
